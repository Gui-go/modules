             ...
             tabsetPanel(
               tabPanel("IS_1",
                        column(12,
                               ...
                               numericInput(ns("ISLMc1_1"), "Propensão Marginal a Consumir", min = 0, max = 1000, step = 0.1, value = 0.8),
               ...
               tabPanel("IS_2",
                        column(12,
                               ...
                               numericInput(ns("ISLMc1_2"), "Propensão Marginal a Consumir", min = 0, max = 1000, step = 0.1, value = 0.8),
